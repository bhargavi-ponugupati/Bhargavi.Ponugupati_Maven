...
class NewYearGift extends App implements Totals{
    ...
    int tot_cost=0;
        ...
        public void chocolates () {
            ...
            ce = s.nextInt();
            if (ce == 1) {
                System.out.println("Enter number of Diarymilk chocolates you want to add:");
                num = s.nextInt();
                tot_weight=tot_weight+d.total_weight(num);
                System.out.println("Total weight of DiaryMilk chocolates you have ordered :"+d.total_weight(num));
                tot_cost=tot_cost+d.total_cost(num);
                System.out.println("Total cost of DiaryMilk:"+d.total_cost(num));

            } else if (ce == 2) {
                System.out.println("Enter number of BarOne chocolates you want to add:");
                num = s.nextInt();
                tot_weight=tot_weight+b.total_weight(num);
                tot_cost=tot_cost+b.total_cost(num);
                System.out.println("Total weight of BarOne chocolates you have ordered :"+b.total_weight(num));
                System.out.println("Total cost of BarOne:"+b.total_cost(num));
            } else if (ce == 3) {
